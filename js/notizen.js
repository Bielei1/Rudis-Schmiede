            ...
            details.innerHTML = `
                <summary style="display: flex; align-items: center; justify-content: space-between;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <span style="font-size: 0.95rem; color: var(--text-muted); font-weight: normal;">${note.createdBy ? `von ${typeof userIdentityHtml === 'function' ? userIdentityHtml(note.createdBy, { size: 24 }) + ' · ' : escapeHtml(note.createdBy) + ' · '}` : ''}Zuletzt geändert: ${note.updatedAt || '-'}</span>
                    </div>
                </summary>
